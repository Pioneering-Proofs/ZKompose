...
export const getPlayerByTokenId = async (
  tokenId: number
): Promise<Player | null> => {
  ...
  return {
    ...json,
    token_id: tokenId,
    image: `https://tan-hidden-gull-949.mypinata.cloud/ipfs/${PLAYERS_SVG_CID}/${json.jersey_number}.svg?pinataGatewayToken=G55brD2rpj1SpsguZn4ayE-IV35guvqsDM0q9abMAAiVvqFTcUr4Gk3pD9ZzoYQz`,
  };
};

export const getPlayersByTokenIds = async (
  tokenIds: number[]
): Promise<Player[]> => {
